...
# Stage 4 and 5 for both bump-hunting problems: the benchmark comparison suite, which reads
# only the merged metric arrays, then the dataset and headline panels, which do load the
# checkpoints and integrate the ODE.
#
